...
/* Private defines -------------------------------------------------------------*/
#define SPI1_CS1_PIN    GPIO_PINS_1
#define SPI1_CS1_GPIO_PORT    GPIOA
#define SPI1_CS2_PIN    GPIO_PINS_2
#define SPI1_CS2_GPIO_PORT    GPIOA
#define SPI1_CS3_PIN    GPIO_PINS_3
#define SPI1_CS3_GPIO_PORT    GPIOA
#define SPI1_CS4_PIN    GPIO_PINS_4
#define SPI1_CS4_GPIO_PORT    GPIOA
#define SPI2_CS1_PIN    GPIO_PINS_12
